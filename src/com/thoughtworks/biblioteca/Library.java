...
public class Library {
    ...
    private List<User> listOfUsers = new ArrayList<>(Arrays.asList(
                                                   new SimpleUser("111-2222", "abcd", "Sidu ponappa", "sidu@c42.com", 9803278365l),
                                                   new LibrarianUser("222-1111", "dcba", "Amie Deep", "Aman@pathashala.com", 523743276527l)));
